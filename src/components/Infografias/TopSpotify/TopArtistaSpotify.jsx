...
const TopArtistaSpotify = () => {
  ...
  useEffect(() => {
    setDatos(prev => ({
      ...prev,
      fecha: `${dia} DE ${mes.toUpperCase()} ${año} (${sourceType === "venezolanos" || sourceType === "globales" || sourceType === "globalesTop50Artistas" ? "OYENTES MENSUALES" : "REPRODUCCIONES ÚLTIMAS 24 H"})`
    }));
